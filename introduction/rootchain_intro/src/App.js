        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="R-nav">
            <ul className="navbar-nav ml-auto">
              <li className="nav-item"><a href="#benefit" className="nav-link"><button className="btn_only" onClick="ReactGA.event({category: 'Benefit', action: 'click nav'});">Benefit</button></a></li>
